...
if ( ! function_exists( 'musea_elated_add_dripicons_icon_pack' ) ) {
	function musea_elated_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new MuseaElatedClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'musea_elated_filter_add_icon_pack_into_collection', 'musea_elated_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'musea_elated_add_dripicons_icon_pack_option' ) ) {
	function musea_elated_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'musea' );
		
		return $options;
	}
	
	add_filter( 'musea_elated_filter_add_icon_pack_into_options', 'musea_elated_add_dripicons_icon_pack_option' );
}

class MuseaElatedClassDripicons implements iMuseaElatedInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->param = $param;
        $this->setIconsArray();
        $this->styleUrl = MUSEA_ELATED_FRAMEWORK_ICONS_ROOT . '/dripicons/dripicons.css';
    }
