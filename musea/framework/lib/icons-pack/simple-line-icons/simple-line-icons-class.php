...
if ( ! function_exists( 'musea_elated_add_simple_line_icon_pack' ) ) {
	function musea_elated_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new MuseaElatedClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'musea_elated_filter_add_icon_pack_into_collection', 'musea_elated_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'musea_elated_add_simple_line_icon_pack_option' ) ) {
	function musea_elated_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'musea' );
		
		return $options;
	}
	
	add_filter( 'musea_elated_filter_add_icon_pack_into_options', 'musea_elated_add_simple_line_icon_pack_option' );
	add_filter( 'musea_elated_filter_add_icon_pack_into_social_options', 'musea_elated_add_simple_line_icon_pack_option' );
}

class MuseaElatedClassSimpleLineIcons implements iMuseaElatedInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->styleUrl = MUSEA_ELATED_FRAMEWORK_ICONS_ROOT . '/simple-line-icons/simple-line-icons.css';
    }
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'musea'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'musea'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'musea'),
            'icon-social-facebook'    => esc_html__('Facebook', 'musea'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'musea'),
            'icon-social-github'      => esc_html__('Github', 'musea'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'musea'),
            'icon-social-instagram'   => esc_html__('Instagram', 'musea'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'musea'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'musea'),
            'icon-social-reddit'      => esc_html__('Reddit', 'musea'),
            'icon-social-skype'       => esc_html__('Skype', 'musea'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'musea'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'musea'),
            'icon-social-spotify'     => esc_html__('Spotify', 'musea'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'musea'),
            'icon-social-twitter'     => esc_html__('Twitter', 'musea'),
            'icon-social-youtube'     => esc_html__('Youtube', 'musea')
        );
    }
