...
if ( ! function_exists( 'musea_elated_add_linea_icon_pack' ) ) {
	function musea_elated_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new MuseaElatedClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'musea_elated_filter_add_icon_pack_into_collection', 'musea_elated_add_linea_icon_pack' );
}

if ( ! function_exists( 'musea_elated_add_linea_icon_pack_option' ) ) {
	function musea_elated_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'musea' );
		
		return $options;
	}
	
	add_filter( 'musea_elated_filter_add_icon_pack_into_options', 'musea_elated_add_linea_icon_pack_option' );
}

class MuseaElatedClassLineaIcons implements iMuseaElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	public function __construct($title = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = MUSEA_ELATED_FRAMEWORK_ICONS_ROOT . '/linea-icons/style.css';
	}
