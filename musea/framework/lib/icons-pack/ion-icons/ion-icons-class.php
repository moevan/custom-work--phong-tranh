...
if ( ! function_exists( 'musea_elated_add_ion_icon_pack' ) ) {
	function musea_elated_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new MuseaElatedClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'musea_elated_filter_add_icon_pack_into_collection', 'musea_elated_add_ion_icon_pack' );
}

if ( ! function_exists( 'musea_elated_add_ion_icon_pack_option' ) ) {
	function musea_elated_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'musea' );
		
		return $options;
	}
	
	add_filter( 'musea_elated_filter_add_icon_pack_into_options', 'musea_elated_add_ion_icon_pack_option' );
	add_filter( 'musea_elated_filter_add_icon_pack_into_social_options', 'musea_elated_add_ion_icon_pack_option' );
}

class MuseaElatedClassIonIcons implements iMuseaElatedInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = MUSEA_ELATED_FRAMEWORK_ICONS_ROOT . '/ion-icons/css/ionicons.min.css';
	}
