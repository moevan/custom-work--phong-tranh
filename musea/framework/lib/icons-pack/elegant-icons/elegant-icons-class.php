...
if ( ! function_exists( 'musea_elated_add_font_elegant_icon_pack' ) ) {
	function musea_elated_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new MuseaElatedClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'musea_elated_filter_add_icon_pack_into_collection', 'musea_elated_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'musea_elated_add_font_elegant_icon_pack_option' ) ) {
	function musea_elated_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'musea' );
		
		return $options;
	}
	
	add_filter( 'musea_elated_filter_add_icon_pack_into_options', 'musea_elated_add_font_elegant_icon_pack_option' );
	add_filter( 'musea_elated_filter_add_icon_pack_into_social_options', 'musea_elated_add_font_elegant_icon_pack_option' );
}

class MuseaElatedClassIconsFontElegant implements iMuseaElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = MUSEA_ELATED_FRAMEWORK_ICONS_ROOT . '/elegant-icons/style.min.css';
	}
