...
if ( ! function_exists( 'musea_elated_add_linear_icon_pack' ) ) {
	function musea_elated_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new MuseaElatedClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'musea_elated_filter_add_icon_pack_into_collection', 'musea_elated_add_linear_icon_pack' );
}

if ( ! function_exists( 'musea_elated_add_linear_icon_pack_option' ) ) {
	function musea_elated_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'musea' );
		
		return $options;
	}
	
	add_filter( 'musea_elated_filter_add_icon_pack_into_options', 'musea_elated_add_linear_icon_pack_option' );
}

class MuseaElatedClassLinearIcons implements iMuseaElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = MUSEA_ELATED_FRAMEWORK_ICONS_ROOT . '/linear-icons/style.css';
	}
