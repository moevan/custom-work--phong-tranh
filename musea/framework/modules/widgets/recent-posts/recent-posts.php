...
if ( class_exists( 'MuseaCoreClassWidget' ) ) {
	class MuseaElatedClassRecentPosts extends MuseaCoreClassWidget {
		public function __construct() {
			parent::__construct(
				'eltdf_recent_posts',
				esc_html__( 'Musea Recent Posts', 'musea' ),
				array( 'description' => esc_html__( 'Select recent posts that you would like to display', 'musea' ) )
			);
		...
		public function widget( $args, $instance ) {
			...
			$html = '<div class="widget eltdf-recent-post-widget" ' . musea_elated_get_inline_style( $widget_styles ) . '>';
			...
			if ( $query->have_posts() ) {
				...
				$html .= esc_html__( 'Sorry, there are no posts matching your criteria', 'musea' );
			}
			...
			echo musea_elated_get_module_part( $html );
		}
	}
}