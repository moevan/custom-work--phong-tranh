...
if ( class_exists( 'MuseaCoreClassWidget' ) ) {
	class MuseaElatedClassClassIconsGroupWidget extends MuseaCoreClassWidget {
		public function __construct() {
			parent::__construct(
				'eltdf_social_icons_group_widget',
				esc_html__( 'Musea Social Icons Group Widget', 'musea' ),
				array( 'description' => esc_html__( 'Use this widget to add a group of up to 6 social icons to a widget area.', 'musea' ) )
			);
		...
		protected function setParams() {
			$this->params = array_merge(
				...
				musea_elated_icon_collections()->getSocialIconWidgetMultipleParamsArray( 6 ),
				array(
					array(
						'type'    => 'dropdown',
						'name'    => 'layout',
						'title'   => esc_html__( 'Icons Layout', 'musea' ),
						'options' => array(
							''             => esc_html__( 'Default', 'musea' ),
							'square-icons' => esc_html__( 'Square', 'musea' ),
						)
					),
					array(
						'type'        => 'dropdown',
						'name'        => 'skin',
						'title'       => esc_html__( 'Square Icons Skin', 'musea' ),
						'description' => esc_html__( 'This applies to the square layout', 'musea' ),
						'options'     => array(
							''           => esc_html__( 'Dark Skin', 'musea' ),
							'light-skin' => esc_html__( 'Light Skin', 'musea' ),
						)
					),
					array(
						'type'    => 'dropdown',
						'name'    => 'alignment',
						'title'   => esc_html__( 'Text Alignment', 'musea' ),
						'options' => array(
					...
					array(
						'type'  => 'textfield',
						'name'  => 'icon_size',
						'title' => esc_html__( 'Icons Size (px)', 'musea' )
					),
					array(
						'type'  => 'colorpicker',
						'name'  => 'color',
