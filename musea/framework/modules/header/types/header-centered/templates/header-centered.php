...
<header class="eltdf-page-header">
    ...
    <div class="eltdf-logo-area">
	    <?php do_action( 'musea_elated_action_after_header_logo_area_html_open' ); ?>
    ...
    <div class="eltdf-menu-area">
        ...
        <?php endif; ?>
            ...
            <div class="eltdf-vertical-align-containers">
                <div class="eltdf-position-center"><!--
                 --><div class="eltdf-position-center-inner">
                        <?php musea_elated_get_main_menu(); ?>
                    </div>
                </div>
            </div>
	...
	<?php if($show_sticky) {
		musea_elated_get_sticky_header('centered', 'header/types/header-centered');
	} ?>
